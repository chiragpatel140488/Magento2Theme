        ...
        $.widget('mage.SwatchRenderer', $['mage']['SwatchRenderer'], {
            ...
            updateBaseImage: function (images, context, isInProductView) {
                ...
                if (isInProductView) {
                    ...
                    // Destroy existing sticky to reapply
                    $('.product.info.detailed, .product-info-main, .product-social-links').mage('sticky', 'destroy');

                    // Reinitialize sticky after destroying
                    $('.product-social-links').mage('sticky', {
                        container: '.product.media'
                    });

                    $('.product.info.detailed, .product-info-main').mage('sticky', {
